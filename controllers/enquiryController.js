  ...
  try {
    ...
    if (adminEmail) {
      ...
      const html = `
        ...
        <p><strong>Phone:</strong> ${escapeHtml(enquiry.phone || "N/A")}</p>
        <p><strong>Email:</strong> ${escapeHtml(enquiry.email || "N/A")}</p>
        <p><strong>Course:</strong> ${escapeHtml(enquiry.course || "N/A")}</p>
